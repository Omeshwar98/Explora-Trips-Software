...
public class CustomerHome extends JFrame implements ActionListener {
    ...
    JButton b1, b2, b3, b4, b5, b6, b7, b8, btn; // Added b8 for Payment button
    JLabel l1;
    ...
    public PaymentPanel paymentpanel; // Added PaymentPanel reference
    ...
    CustomerHome(String user) {
        ...
        b8 = createButton("Payment"); // Create Payment button
        sidebarpanel.add(b8); // Add Payment button to sidebar
    ...
    public void disablePanel() {
        ...
        } else if (paymentpanel != null && paymentpanel.isVisible()) { // Disable payment panel if visible
    ...
    public void openPanel(Object source) {
        if (source == b1) {
            activeButton(b1);
            homepanel.setVisible(true); // Reuse existing homepanel
        ...
        } else if (source == b8) { // Handle Payment button click
            activeButton(b8);
            paymentpanel = new PaymentPanel(this, user); // Create a new PaymentPanel
            contentPane.add(paymentpanel);
            paymentpanel.setVisible(true); // Show the payment panel
        }
    }
}
